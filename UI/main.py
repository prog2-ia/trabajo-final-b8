...
# Importaciones exactas respetando tus mayúsculas de carpetas y archivos
...
def main():
    # Cargamos el estado del archivo binario
    ...
    while not salir:
        ...
        if opcion == "1":
            ...
            # Listar Alumnos usando sus atributos reales
            print("\nAlumnos disponibles:")
            ...
            # Listar Profesores usando sus atributos reales
            ...
            # Listar Vehículos CORREGIDO: ahora usa _marca y _modelo con guion bajo
            ...
            print(f"-> Validación: {nueva_clase.validar_compatibilidad()}")
            ...
            for cl in mi_autoescuela._lista_clases:
                ...
                try:
                    ...
                    # Usamos las propiedades públicas de ClasePractica (fecha y alumno)
            ...
            # Genera el archivo informe_alumnos.txt en la raíz
